document.addEventListener('DOMContentLoaded', function() {
	...
	(function getTime() {
		...
		hour_hand.style.transform = `rotate(${hour_pos}deg) translateY(-9rem)`;
		min_hand.style.transform = `rotate(${min_pos}deg) translateY(-10rem)`;
		sec_hand.style.transform = `rotate(${sec_pos}deg) translateY(-11rem)`;
